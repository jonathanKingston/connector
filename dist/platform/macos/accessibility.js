...
export async function getAccessibilityTree(pid, maxDepth = DEFAULT_MAX_DEPTH) {
...
export async function getMenuBar(pid) {
    const script = `
var se = Application('System Events');
var proc = se.processes.whose({unixId: ${pid}})[0];
...
export async function clickMenuItem(pid, menuPath) {
